...
@Repository
public interface JpaPersonFlowRepository
    extends JpaRepository<JpaPersonFlow, Long>, JpaSpecificationExecutor<JpaPersonFlow> {
  @Query("SELECT e FROM JpaPersonFlow e WHERE e.createdTime BETWEEN :startDate AND :endDate")
  List<JpaPersonFlow> findDataBetweenDates(
